    ...
    <div v-if="loadedTheme" class="container mt-3">
        ...
        <div v-if="enableEditMode" class="sidebar" data-testid="edit-sidebar">
            <div class="sidebar-body">
                ...
                <div class="my-3 form-check form-switch">
                    <input id="showMessage" v-model="config.showMessage" class="form-check-input" type="checkbox" data-testid="show-message-checkbox">
                    <label class="form-check-label" for="showMessage">{{ $t("Show Message") }}</label>
                </div>
        ...
        <div :class="{ edit: enableEditMode}" class="main">
            ...
            <div class="mb-4">
                ...
                <PublicGroupList :edit-mode="enableEditMode" :show-tags="config.showTags" :show-message="config.showMessage" :show-certificate-expiry="config.showCertificateExpiry" />
            </div>
